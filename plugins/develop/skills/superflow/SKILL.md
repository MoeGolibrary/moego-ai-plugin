...
Phase 1: Planning (writing-plans)
         ↓
Phase 1.5: E2E Planning (develop:e2e) [自动判断]
         ↓
Phase 2: Environment (using-git-worktrees)
         ↓
Phase 3: Execution (subagent-driven-development)
         ↓
Phase 3.5: E2E Implementation (develop:e2e) [自动触发]
         ↓
...
1. 自动调用 `develop:e2e` 技能的 Plan 模式
2. 基于设计文档和实现计划生成测试场景
